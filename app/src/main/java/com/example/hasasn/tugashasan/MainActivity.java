package com.example.hasasn.tugashasan;
...
public class MainActivity extends AppCompatActivity {
    ...
    String no_telp = "082238952501";
    String email = "hasanmadzkur98@gmail.com";
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","hasanmadzkur98@gmail.com", null));
